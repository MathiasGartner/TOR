...
PULSE_MAGNET_TIME_MS = 150
PULSE_MAGNET_TIME_S = PULSE_MAGNET_TIME_MS / 1000.0
...
INA_OVERFLOW_VAL = INA_CURRENT_THRESHOLD + 1

USE_OTPW = True
OTPW_MAX_COUNT = 3
OTPW_WAIT_S = 2
MIN_TIME_BETWEEN_FUNCTIONALITY_CHECKS_S = 1
...
CORD_CORRECTION_C = 0.874394
CORD_CORRECTION_C2 = 0.000371901
CORD_CORRECTION_INV_C0 = 0.764565
CORD_CORRECTION_INV_C1 = 0.0014876
CORD_CORRECTION_INV_A = 1344.44
CORD_CORRECTION_INV_B = -0.874394
...
DROPOFF_ADVANCE_POSITION = Position(60, 30, 30) # for testing
DROPOFF_POSITION = Position(60, 8, 11) # for testing
DROPOFF_ADVANCE_OFFSET_Y = 20
DROPOFF_ADVANCE_OFFSET_Z = 18
DROPOFF_ADVANCE_OFFSET_Y2 = 15
DROPOFF_ADVANCE_OFFSET_Z2 = 12
DROPOFF_ADVANCE_Z = 50 # for testing
...
HOME_EVERY_N_RUNS = 200
HOME_AFTER_N_NOT_FOUND = 2
PAUSE_AFTER_N_SAME_RESULTS = 4
MAX_COUNT_NO_MAGNET_CONTACT_RETRIES = 2
MAX_COUNT_NO_MAGNET_CONTACT_GLOBAL = 8
SAME_RESULT_NEAR_THRESHOLD = 0.05
...
HOME_AFTER_N_IMAGES_TAKEN = 20
NEAR_RAMP_Y = 0.2
LOW_PICKUP_Z_OFFSET = 2
SIDEWAYS_PICKUP_Y_OFFSET = 0.1
